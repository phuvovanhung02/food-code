...
!(function (e, t) {
        ...
        ie = n(function (e) {
            ...
            (e.exports = function (e, t, a, o) {
                var s = !!o && !!o.unsafe,
                    ...
                    u = !!o && !!o.noTargetGet;
                'function' == typeof a &&
                    ('string' != typeof t || w(a, 'name') || N(a, 'name', t), (n(a).source = i.join('string' == typeof t ? t : ''))),
    ...
    (ra || oa || aa) &&
        (ia = function (e) {
            ...
            return (
                ...
                o
                    ? i
                        ? ((i.input = i.input.slice(u)), (i[0] = i[0].slice(u)), (i.index = a.lastIndex), (a.lastIndex += i[0].length))
                        : (a.lastIndex = 0)
    ...
    !(function (e, t, n, i, r, a, o) {
        ...
        if (
            ...
            if (((l = { values: d(xa), keys: a ? p : d(Ra), entries: d(La) }), o)) for (u in l) (ka || f || !(u in v)) && ie(v, u, l[u]);
                ...
                (i =
                    ...
                    ''.split(/.?/).length
                        ? function (e, n) {
                              ...
                              return (
                                  f === a.length ? (!u && v.test('')) || c.push('') : c.push(a.slice(f)), c.length > o ? c.slice(0, o) : c
                              );
                          }
    ...
    var wo = function (e, t) {
        ...
        Lo = function (e, t, n) {
            for (
                var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : '', r = e.querySelectorAll('.' + n), a = 0;
                a < r.length;
                a++
            ) {
                var o = r[a];
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            t &&
                                ...
                                So(e, 'video[data-lazy-loaded][src], audio[data-lazy-loaded][src], iframe[data-lazy-loaded][src]').forEach(
                                    function (e) {
        ...
        Uo = function (e) {
            ...
            if (t && t[1])
                return (
                    (t = t[1]), { r: 17 * parseInt(t.charAt(0), 16), g: 17 * parseInt(t.charAt(1), 16), b: 17 * parseInt(t.charAt(2), 16) }
                );
            var n = e.match(/^#([0-9a-f]{6})$/i);
            if (n && n[1])
                return (n = n[1]), { r: parseInt(n.substr(0, 2), 16), g: parseInt(n.substr(2, 2), 16), b: parseInt(n.substr(4, 2), 16) };
                ...
                no(e, [
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            i.background &&
                                (/^(http|file|\/\/)/gi.test(i.background) || /\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(i.background)
    ...
    function Ps(e, t) {
        ...
        function tt(e) {
            'running' === g &&
                ...
                ((g = 'idle'), Q({ type: 'slidetransitionend', data: { indexh: n, indexv: i, previousSlide: r, currentSlide: a } }));
        }
        function nt(e) {
            oe();
        }
