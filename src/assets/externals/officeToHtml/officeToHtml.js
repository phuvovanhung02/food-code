...
(function ($) {
    ...
    function getPdfContent(fObj, divId, pdfSet) {
        ...
        $('<span></span>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #sidebarContainer #toolbarSidebar .splitToolbarButton #viewThumbnail'
        );
        ...
        $('<span></span>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #sidebarContainer #toolbarSidebar .splitToolbarButton #viewOutline'
        );
        ...
        $('<span></span>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #sidebarContainer #toolbarSidebar .splitToolbarButton #viewAttachments'
        );
        ///////////////////////////////////////////////////////////////////////////////////////////
        $('<div></div>', {
            id: 'thumbnailView',
        ...
        $('<button></button>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #mainContainer #findbar #findbarInputContainer .splitToolbarButton'
        );
        $('<span></span>', {
        ...
        $('<button></button>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #mainContainer #secondaryToolbar #secondaryToolbarButtonContainer'
        );
        $('<span></span>', {
        ...
        $('<span></span>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #overlayContainer #passwordOverlay .dialog .buttonRow #passwordCancel'
        );
        $('<button></button>', {
            id: 'passwordSubmit',
            class: 'overlayButton',
        ...
        $('<span></span>', {
            ...
            'div#' + divId + ' .loadingInProgress #outerContainer #overlayContainer #passwordOverlay .dialog .buttonRow #passwordSubmit'
        );
        ...
        $('<link>', {
            ...
            href: 'assets/externals/pdf/locale/locale.properties',
        }).appendTo('#' + divId);
            ...
            /******/ [
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    _pdfjsLib.PDFJS.disableFullscreen =
                        _pdfjsLib.PDFJS.disableFullscreen === undefined ? false : _pdfjsLib.PDFJS.disableFullscreen;
                    _pdfjsLib.PDFJS.useOnlyCssZoom = _pdfjsLib.PDFJS.useOnlyCssZoom === undefined ? false : _pdfjsLib.PDFJS.useOnlyCssZoom;
                    _pdfjsLib.PDFJS.maxCanvasPixels =
                        _pdfjsLib.PDFJS.maxCanvasPixels === undefined ? 16777216 : _pdfjsLib.PDFJS.maxCanvasPixels;
                    _pdfjsLib.PDFJS.disableHistory = _pdfjsLib.PDFJS.disableHistory === undefined ? false : _pdfjsLib.PDFJS.disableHistory;
                    _pdfjsLib.PDFJS.disableTextLayer =
                        _pdfjsLib.PDFJS.disableTextLayer === undefined ? false : _pdfjsLib.PDFJS.disableTextLayer;
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    function configure(PDFJS) {
                        ...
                        PDFJS.workerSrc = location.href + 'pdf-worker.js';
                            ...
                            },
                            {
                                ...
                                value: function _setScale(value) {
                                    ...
                                    if (scale > 0) {
                                        ...
                                        var hPadding =
                                            this.isInPresentationMode || this.removePageBorders ? 0 : _ui_utils.SCROLLBAR_PADDING;
                            ...
                            },
                            {
                                ...
                                value: function scrollPageIntoView(params) {
                                    ...
                                    switch (dest[1].name) {
                                        ...
                                        default:
                                            console.error(
                                                'PDFViewer.scrollPageIntoView: "' + dest[1].name + '" ' + 'is not a valid destination type.'
                                            );
                                            return;
                                    }
    ...
    function getDocxContent(fObj, divId, docxSet) {
        ...
        req.onload = function (e) {
            mammoth.convertToHtml({ arrayBuffer: req.response }, mammothOptions).then(displayResult).done();
        };
        req.send();
        // JSZipUtils.getBinaryContent(file, function (err, content) {
        //     mammoth.convertToHtml({ arrayBuffer: content }, mammothOptions).then(displayResult).done();
        // });
