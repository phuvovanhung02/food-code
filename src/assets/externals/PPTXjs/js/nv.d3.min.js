    ...
    (a.dev = !1),
                    ...
                    function m() {
                        ...
                        if (
                            (k &&
                                ...
                                d3.event.target.className.baseVal.match('nv-legend') && (i = !0)),
                            h && ((d -= c.left), (e -= c.top)),
                            0 > d ||
                                0 > e ||
                                d > o ||
                            ...
                            if (
                                ...
                                (void 0 === d3.event.relatedTarget.className ||
                                    d3.event.relatedTarget.className.match(j.nvPointerEventsClass))
                            )
                                return;
                        ...
                        j.hidden(!1);
                        var l = f.invert(d);
                        g.elementMousemove({ mouseX: d, mouseY: e, pointXValue: l }),
                            'dblclick' === d3.event.type && g.elementDblclick({ mouseX: d, mouseY: e, pointXValue: l }),
                            'click' === d3.event.type && g.elementClick({ mouseX: d, mouseY: e, pointXValue: l }),
                            'mousedown' === d3.event.type && g.elementMouseDown({ mouseX: d, mouseY: e, pointXValue: l }),
        ...
        (a.models.tooltip = function () {
            ...
            function b() {
                if (!m) {
                    ...
                    (m = d3
                        ...
                        .attr('id', d)),
                        m.style('top', 0).style('left', 0),
                        m.style('opacity', 0),
                        m.style('position', 'fixed'),
                        m.selectAll('div, table, td, tr').classed(r, !0),
                        m.classed(r, !0);
                }
            }
            function c() {
            ...
            var d = 'nvtooltip-' + Math.floor(1e5 * Math.random()),
                ...
                l = 200,
                m = null,
                n = { left: null, top: null },
                o = !0,
                p = 100,
                q = !0,
                r = 'nv-pointer-events-none',
                s = function () {
                ...
                y = function (a) {
                    var b,
                        c,
                        d,
                        e = m.node().offsetHeight,
                        h = m.node().offsetWidth,
                ...
                z = function () {
                    a.dom.read(function () {
                        ...
                        if (k) m.interrupt().transition().delay(l).duration(0).style('opacity', 0);
                            ...
                            var e = 'translate(' + n.left + 'px, ' + n.top + 'px)',
                                f = 'translate(' + c + 'px, ' + d + 'px)',
                                g = d3.interpolateString(e, f),
                                h = m.style('opacity') < 0.1;
                            m.interrupt()
                                .transition()
                                .duration(h ? 0 : p)
                                .styleTween(
            ...
            function b(g) {
                return (
                    ...
                    g.each(function (b) {
                        ...
                        null !== n
                            ? c.ticks(n)
                            : ('top' == c.orient() || 'bottom' == c.orient()) && c.ticks(Math.abs(d.range()[1] - d.range()[0]) / 100),
                        ...
                        switch (c.orient()) {
                            case 'top':
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    (y = 0),
                                    1 === d.range().length
                                        ? (y = m ? 2 * d.range()[0] + d.rangeBand() : 0)
                                        : 2 === d.range().length
                                        ? (y = m ? d.range()[0] + d.range()[1] + d.rangeBand() : d.range()[1])
                                        : d.range().length > 2 && (y = d.range()[d.range().length - 1] + (d.range()[1] - d.range()[0])),
                                    v
                        ...
                        if (
                            ...
                            p.selectAll('g.nv-axisMaxMin').each(function (a, b) {
                                try {
                                    b
                                        ? E.push(d(a) - this.getBoundingClientRect().width - 4)
                                        : E.push(d(a) + this.getBoundingClientRect().width + 4);
                                } catch (c) {
                                ...
                                t.selectAll('g').each(function (a, b) {
                                    (d(a) < E[0] || d(a) > E[1]) &&
                                        (a > 1e-10 || -1e-10 > a ? d3.select(this).remove() : d3.select(this).select('text').remove());
                                });
                        }
                        t
                            .selectAll('.tick')
                            ...
                            ['low', 'high'].forEach(function (a) {
                                B.selectAll('.nv-boxplot-' + a)
                                    .on('mouseover', function (b, c, d) {
                                        d3.select(this).classed('hover', !0),
                                            s.elementMouseover({ series: { key: b.values['whisker_' + a], color: q(b, d) }, e: d3.event });
                                    })
                                    .on('mouseout', function (b, c, d) {
                                        d3.select(this).classed('hover', !1),
                                            s.elementMouseout({ series: { key: b.values['whisker_' + a], color: q(b, d) }, e: d3.event });
                                    })
                                    .on('mousemove', function (a, b) {
                                        s.elementMousemove({ e: d3.event });
                                    });
                ...
                return (
                    x.each(function (b) {
                        ...
                        l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
                            v
                                ? l.range(f || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length])
                            ...
                            l.domain()[0] === l.domain()[1] &&
                                (l.domain()[0]
                                    ? l.domain([l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]])
                                    : l.domain([-1, 1])),
                            m.domain()[0] === m.domain()[1] &&
                                (m.domain()[0]
                                    ? m.domain([m.domain()[0] + 0.01 * m.domain()[0], m.domain()[1] - 0.01 * m.domain()[1]])
                                    : m.domain([-1, 1]));
                        ...
                        if ((L.selectAll('.nv-noData').remove(), (d = f.xScale()), (e = f.yScale()), w)) f.yDomain(null);
                            ...
                            var R = l
                                    ...
                                    .map(function (a, b) {
                                        ...
                                        return c[0] < -0.95 && (c[0] = -0.95), [(c[0] - c[1]) / (1 + c[1]), (c[1] - c[0]) / (1 + c[0])];
                                    }),
                                S = [
                                    d3.min(R, function (a) {
                                        return a[0];
            ...
            function b(h) {
                return (
                    ...
                    h.each(function (h) {
                        var l = d3.select(this);
                        a.utils.initSVG(l);
                        var s = a.utils.availableWidth(j, l, i),
                            v = a.utils.availableHeight(k, l, i);
                        if (
                            ((b.update = function () {
                        ...
                        x.append('g').attr('class', 'nv-x nv-axis'),
                            ...
                            x.append('g').attr('class', 'nv-barsWrap'),
                            z.attr('transform', 'translate(' + i.left + ',' + i.top + ')'),
                            o && z.select('.nv-y.nv-axis').attr('transform', 'translate(' + s + ',0)'),
                            e.width(s).height(v);
                        var A = z.select('.nv-barsWrap').datum(
                            h.filter(function (a) {
                                return !a.disabled;
                        ...
                        if (
                            ...
                            f
                                .scale(c)
                                ._ticks(a.utils.calcTicksX(s / 100, h))
                                .tickSize(-v, 0),
                                z
                                    .select('.nv-x.nv-axis')
                                    .attr(
                                        'transform',
                                        'translate(0,' + (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) + ')'
                                    ),
                                z.select('.nv-x.nv-axis').call(f);
                            var B = z.select('.nv-x.nv-axis').selectAll('g');
                            p &&
                                ...
                                r &&
                                    B.selectAll('.tick text')
                                        .attr('transform', 'rotate(' + r + ' 0,0)')
                                        .style('text-anchor', r > 0 ? 'start' : 'end'),
                                q && z.selectAll('.tick text').call(a.utils.wrapTicks, b.xAxis.rangeBand());
                        }
                        n &&
                            (g
                                .scale(d)
                                ._ticks(a.utils.calcTicksY(v / 36, h))
                                .tickSize(-s, 0),
                            z.select('.nv-y.nv-axis').call(g)),
                            z.select('.nv-zeroLine line').attr('x1', 0).attr('x2', s).attr('y1', d(0)).attr('y2', d(0));
                    }),
                    v.renderEnd('discreteBar chart immediate'),
                    b
                );
            }
            var c,
                ...
                r = 0,
                s = null,
                t = d3.dispatch('beforeUpdate', 'renderEnd'),
                u = 250;
            f
                .orient('bottom')
                .showMaxMin(!1)
            ...
            function b(q) {
                ...
                return (
                    q.each(function (b) {
                        ...
                        var w,
                            x = v.selectAll('.nv-series').data(function (a) {
                                return 'furious' != p
                                    ? a
                                    : a.filter(function (a) {
                        ...
                        if ('classic' == p)
                            ...
                            y.append('rect').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('rx', 3).attr('ry', 3),
                                (w = x.select('rect')),
                                y
                                    .append('g')
                            ...
                            .on('dblclick', function (a, b) {
                                if (('furious' != p || !n) && (o.legendDblclick(a, b), l)) {
                                    ...
                                    c.forEach(function (a) {
                                        ...
                                        (a.disabled = !1),
                                        'furious' == p && (a.userDisabled = a.disabled),
                                        o.stateChange({
                                            disabled: c.map(function (a) {
                                                return !!a.disabled;
                                            }),
                        ...
                        if (i) {
                            ...
                            x.each(function (b, c) {
                                ...
                                if (f(b).length > h) {
                                    ...
                                    (d = d3
                                        ...
                                        .select('text')
                                        .text(e + '...')),
                                        d3.select(this).append('svg:title').text(f(b));
                            ...
                            x.attr('transform', function (a, b) {
                                ...
                                k
                                    ? v.attr('transform', 'translate(' + (d - c.right - E) + ',' + c.top + ')')
                                    : v.attr('transform', 'translate(0,' + c.top + ')'),
                                (e = c.top + c.bottom + Math.ceil(C.length / D) * B);
                        } else {
                            var K,
                                L = 5,
                                M = 5,
                            ...
                            x.attr('transform', function (a, b) {
                                ...
                                return (
                                    (K = M),
                                    d < c.left + c.right + K + e && ((M = K = 5), (L += B)),
                                    (M += e),
                                    M > N && (N = M),
                                    'translate(' + K + ',' + L + ')'
                                );
                        ...
                        'furious' == p &&
                            w
                                ...
                                .attr('y', -9)
                                .attr('x', -15),
                            w.style('fill', s).style('stroke', function (a, b) {
                ...
                return (
                    x.each(function (b) {
                        ...
                        a.utils.initSVG(k),
                            ...
                            r
                                ? l.range(e || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length])
                                : l.range(e || [0, x]),
                        ...
                        E.exit().remove(),
                            E.enter()
                                ...
                                .on('mouseover', function (a, b) {
                                    v &&
                                        (d3.select(this).classed('hover', !0),
                                        u.elementMouseover({ data: a, index: b, color: d3.select(this).style('fill') }));
                                })
                                .on('mouseout', function (a, b) {
                                    v &&
                                        (d3.select(this).classed('hover', !1),
                            ...
                            j.dispatch.on('elementMousemove', function (b) {
                                ...
                                k.filter(function (a, b) {
                                    ...
                                    void 0 !== j &&
                                        ...
                                        l.push({ key: g.key, value: c.y()(j, e), color: m(g, g.seriesIndex), data: g.values[e] }));
                                });
                ...
                return (
                    q.each(function (b) {
                        ...
                        var u = q.selectAll('g.nv-legend').data([b]),
                            v = u.enter().append('g').attr('class', 'nvd3 nv-legend').append('g'),
                            w = u.select('g');
                        u.attr('transform', 'translate(' + c.left + ',' + c.top + ')');
                        var x,
                            y,
                            z = w.selectAll('.nv-series').data(function (a) {
                                return 'furious' != p
                                    ? a
                                    : a.filter(function (a) {
                                          return n ? !0 : !a.disengaged;
                        ...
                        if ('classic' == p)
                            A.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5),
                                (x = z.select('circle'));
                        else if ('furious' == p) {
                            A.append('rect').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('rx', 3).attr('ry', 3),
                                (x = z.select('.nv-legend-symbol')),
                                A.append('g')
                                    .attr('class', 'nv-check-box')
                                    .property(
                                        'innerHTML',
                        ...
                        if (i) {
                            ...
                            z.attr('transform', function (a, b) {
                                ...
                                k
                                    ? w.attr('transform', 'translate(' + (d - c.right - D) + ',' + c.top + ')')
                                    : w.attr('transform', 'translate(0,' + c.top + ')'),
                                (e = c.top + c.bottom + Math.ceil(E.length / F) * y);
                        } else {
                            var L,
                                M = 5,
                                N = 5,
                            ...
                            z.attr('transform', function (a, b) {
                                ...
                                return (
                                    (L = N),
                                    d < c.left + c.right + L + e && ((N = L = 5), (M += y)),
                                    (N += e),
                                    N > O && (O = N),
                                    L + O > D && (D = L + O),
                                    'translate(' + L + ',' + M + ')'
                                ...
                                w.attr('transform', 'translate(' + (d - c.right - O) + ',' + c.top + ')'),
                        ...
                        if ('furious' == p) {
                            x
                                ...
                                .attr('y', -9)
                                .attr('x', -15),
                                v.insert('rect', ':first-child').attr('class', 'nv-legend-bg').attr('fill', '#eee').attr('opacity', 0);
                                    ...
                                    (j
                                        ...
                                        .forEach(function (f, g) {
                                            ...
                                            null != j && e.highlightPoint(g, h, !0),
                                                void 0 !== i &&
                                                    (void 0 === d && (d = i),
                                                    void 0 === k && (k = b.xScale()(b.x()(i, h))),
                                                    m.push({ key: f.key, value: j, color: l(f, f.seriesIndex) }));
                                        }),
                                    m.length > 2)
                                ) {
            ...
            function b(v) {
                return (
                    v.each(function (v) {
                        ...
                        function T() {
                            u.empty() || u.extent(I),
                                la.data([u.empty() ? e.domain() : I]).each(function (a, b) {
                        ...
                        function U() {
                            ...
                            var b = ea.select('.nv-focus .nv-barsWrap').datum(
                                    $.length
                                        ? $.map(function (a, b) {
                                              return {
                                                  key: a.key,
                                ...
                                h = ea.select('.nv-focus .nv-linesWrap').datum(
                                    S(_)
                                        ? [{ values: [] }]
                                        : _.filter(function (a) {
                                              return !a.disabled;
                            ...
                            (d = $.length ? l.xScale() : j.xScale()),
                                n
                                    .scale(d)
                                    ._ticks(a.utils.calcTicksX(W / 100, v))
                                    .tickSize(-X, 0),
                                n.domain([Math.ceil(c[0]), Math.floor(c[1])]),
                                ea.select('.nv-x.nv-axis').transition().duration(L).call(n),
                                b.transition().duration(L).call(l),
                                h.transition().duration(L).call(j),
                                ea.select('.nv-focus .nv-x.nv-axis').attr('transform', 'translate(0,' + f.range()[0] + ')'),
                                p
                                    .scale(f)
                                    ._ticks(a.utils.calcTicksY(X / 36, v))
                                    .tickSize(-W, 0),
                                q
                                    .scale(g)
                                    ._ticks(a.utils.calcTicksY(X / 36, v))
                                    .tickSize($.length ? 0 : -W, 0),
                                ea.select('.nv-focus .nv-y1.nv-axis').style('opacity', $.length ? 1 : 0),
                                ea
                                    .select('.nv-focus .nv-y2.nv-axis')
                                    .style('opacity', _.length && !S(_) ? 1 : 0)
                                    .attr('transform', 'translate(' + d.range()[1] + ',0)'),
                                ea.select('.nv-focus .nv-y1.nv-axis').transition().duration(L).call(p),
                                ea.select('.nv-focus .nv-y2.nv-axis').transition().duration(L).call(q);
                        }
                        var V = d3.select(this);
                        a.utils.initSVG(V);
                        var W = a.utils.availableWidth(y, V, w),
                            X = a.utils.availableHeight(z, V, w) - (E ? H : 0),
                            Y = H - x.top - x.bottom;
                        if (
                            ((b.update = function () {
                        ...
                        d.range([0, W]),
                            e
                                .domain(
                                    d3.extent(d3.merge(aa.concat(ba)), function (a) {
                                        return a.x;
                                    })
                                )
                                .range([0, W]);
                        ...
                        fa.append('g').attr('class', 'nv-x nv-axis'),
                            fa.append('g').attr('class', 'nv-y1 nv-axis'),
                            fa.append('g').attr('class', 'nv-y2 nv-axis'),
                            fa.append('g').attr('class', 'nv-barsWrap'),
                            fa.append('g').attr('class', 'nv-linesWrap');
                        ...
                        if (
                            ...
                            ga.append('g').attr('class', 'nv-brushBackground'),
                            ga.append('g').attr('class', 'nv-x nv-brush'),
                            D)
                        ) {
                            var ha = t.align() ? W / 2 : W,
                                ia = t.align() ? ha : 0;
                            t.width(ha),
                                ea
                                    ...
                                    .call(t),
                                w.top != t.height() && ((w.top = t.height()), (X = a.utils.availableHeight(z, V, w) - H)),
                                ea.select('.nv-legendWrap').attr('transform', 'translate(' + ia + ',' + -w.top + ')');
                        }
                        ca.attr('transform', 'translate(' + w.left + ',' + w.top + ')'),
                            ea.select('.nv-context').style('display', E ? 'initial' : 'none'),
                            m
                                .width(W)
                                .height(Y)
                                .color(
                        ...
                        var ja = ea.select('.nv-context .nv-barsWrap').datum($.length ? $ : [{ values: [] }]),
                            ka = ea.select('.nv-context .nv-linesWrap').datum(
                                S(_)
                                    ? [{ values: [] }]
                                    : _.filter(function (a) {
                                          return !a.disabled;
                        ...
                        ea.select('.nv-context').attr('transform', 'translate(0,' + (X + w.bottom + x.top) + ')'),
                            ja.transition().call(m),
                            ka.transition().call(k),
                            G &&
                                (o._ticks(a.utils.calcTicksX(W / 100, v)).tickSize(-Y, 0),
                                ea.select('.nv-context .nv-x.nv-axis').attr('transform', 'translate(0,' + h.range()[0] + ')'),
                                ea.select('.nv-context .nv-x.nv-axis').transition().call(o)),
                            F &&
                                (r
                                    .scale(h)
                                    ._ticks(Y / 36)
                                ...
                                ea.select('.nv-context .nv-y1.nv-axis').transition().call(r),
                                ea.select('.nv-context .nv-y2.nv-axis').transition().call(s)),
                            u.x(e).on('brush', U),
                            I && u.extent(I);
                        var la = ea
                        ...
                        ma.append('rect').attr('class', 'left').attr('x', 0).attr('y', 0).attr('height', Y),
                            ma.append('rect').attr('class', 'right').attr('x', 0).attr('y', 0).attr('height', Y);
                        var na = ea.select('.nv-x.nv-brush').call(u);
                        na.selectAll('rect').attr('height', Y),
                            na.selectAll('.resize').append('path').attr('d', J),
            ...
            function b(o) {
                return (
                    o.each(function (o) {
                        ...
                        function G() {
                            n.empty() || n.extent(y),
                                U.data([n.empty() ? e.domain() : y]).each(function (a, b) {
                                    var d = e(a[0]) - c.range()[0],
                                        f = K - e(a[1]);
                                    d3
                                        .select(this)
                                        .select('.left')
                ...
                (b._options = Object.create(
                    {},
                    {
                        ...
                        focusMargin: {
                            ...
                            set: function (a) {
                                (r.top = void 0 !== a.top ? a.top : r.top),
                                    (r.right = void 0 !== a.right ? a.right : r.right),
                                    (r.bottom = void 0 !== a.bottom ? a.bottom : r.bottom),
                                    (r.left = void 0 !== a.left ? a.left : r.left);
                            },
                        },
                        color: {
                            get: function () {
                    ...
                    E.each(function (b) {
                                ...
                                b[0].values.map(function (a, c) {
                                    ...
                                    b.map(function (a, f) {
                                        if (!b[f].nonStackable) {
                                            var g = a.values[c];
                                            (g.size = Math.abs(g.y)),
                                                g.y < 0 ? ((g.y1 = e), (e -= g.size)) : ((g.y1 = g.size + d), (d += g.size));
                                        }
                                    });
                                });
                        var I =
                        ...
                        m
                            ...
                            n.domain()[0] === n.domain()[1] &&
                                (n.domain()[0]
                                    ? n.domain([n.domain()[0] + 0.01 * n.domain()[0], n.domain()[1] - 0.01 * n.domain()[1]])
                                    : n.domain([-1, 1])),
                            (h = h || m),
                            (i = i || n);
                                  ...
                                  .attr('x', function (a, c, d) {
                                      ...
                                      return (
                                          b[d].nonStackable &&
                                              ...
                                              b.length !== G && (e = (b[d].nonStackableSeries * m.rangeBand()) / (2 * G))),
                                          e
                                      );
                                  })
                                  .attr('width', function (a, c, d) {
            ...
            function b(j) {
                return (
                    ...
                    j.each(function (j) {
                        ...
                        a.utils.initSVG(A);
                        var E = a.utils.availableWidth(l, A, k),
                            I = a.utils.availableHeight(m, A, k);
                        if (
                            ((b.update = function () {
                                0 === D ? A.call(b) : A.transition().duration(D).call(b);
                            }),
                            (b.container = this),
                            y.setter(H(j), b.update).getter(G(j)).update(),
                            (y.disabled = j.map(function (a) {
                                return !!a.disabled;
                            })),
                            !z)
                        ) {
                        ...
                        if (
                            ...
                            L.append('g').attr('class', 'nv-barsWrap'),
                            L.append('g').attr('class', 'nv-legendWrap'),
                            L.append('g').attr('class', 'nv-controlsWrap'),
                            q &&
                                (h.width(E - C()),
                                M.select('.nv-legendWrap').datum(j).call(h),
                                k.top != h.height() && ((k.top = h.height()), (I = a.utils.availableHeight(m, A, k))),
                                M.select('.nv-legendWrap').attr('transform', 'translate(' + C() + ',' + -k.top + ')')),
                            o)
                        ) {
                            var N = [
                            ...
                            i.width(C()).color(['#444', '#444', '#444']),
                                M.select('.nv-controlsWrap')
                                    .datum(N)
                                    .attr('transform', 'translate(0,' + -k.top + ')')
                                    .call(i);
                        }
                        K.attr('transform', 'translate(' + k.left + ',' + k.top + ')'),
                            t && M.select('.nv-y.nv-axis').attr('transform', 'translate(' + E + ',0)'),
                            e
                                .disabled(
                                    j.map(function (a) {
                                        return a.disabled;
                        ...
                        var O = M.select('.nv-barsWrap').datum(
                            j.filter(function (a) {
                                return !a.disabled;
                            })
                        );
                        if ((O.call(e), r)) {
                            f
                                .scale(c)
                                ._ticks(a.utils.calcTicksX(E / 100, j))
                                .tickSize(-I, 0),
                                M.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + d.range()[0] + ')'),
                                M.select('.nv-x.nv-axis').call(f);
                            ...
                            w && M.selectAll('.tick text').call(a.utils.wrapTicks, b.xAxis.rangeBand()),
                                u &&
                                    P.filter(function (a, b) {
                                        ...
                                        .style('opacity', 0),
                                x &&
                                    P.selectAll('.tick text')
                                        .attr('transform', 'rotate(' + x + ' 0,0)')
                                        .style('text-anchor', x > 0 ? 'start' : 'end'),
                                M.select('.nv-x.nv-axis').selectAll('g.nv-axisMaxMin text').style('opacity', 1);
                        }
                        s &&
                            (g
                                .scale(d)
                            ...
                            B.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    (y.disabled = a.disabled)),
                                    'undefined' != typeof a.stacked && (e.stacked(a.stacked), (y.stacked = a.stacked), (F = a.stacked)),
                                    b.update();
                            });
                    }),
                    E.renderEnd('multibarchart immediate'),
                    b
                );
            }
            var c,
                ...
                z = null,
                A = null,
                B = d3.dispatch('stateChange', 'changeState', 'renderEnd'),
                C = function () {
                    return o ? 180 : 0;
                },
                D = 250;
                ...
                return (
                    ...
                    m.each(function (b) {
                        ...
                        o
                            ...
                            x && !w ? p.range(g || [p.domain()[0] < 0 ? z : 0, m - (p.domain()[1] > 0 ? z : 0)]) : p.range(g || [0, m]),
                            (h = h || o),
                            (i =
                                i ||
                                d3.scale
        ...
        (a.models.multiChart = function () {
                ...
                return (
                    j.each(function (j) {
                        function n(a) {
                            ...
                            (a.value = a.point.x),
                                (a.series = { value: a.point.y, color: a.point.color, key: a.series.key }),
                                D.duration(0)
                        ...
                        function F(a) {
                            var b = 2 === j[a.seriesIndex].yAxis ? B : A;
                            (a.point.x = x.x()(a.point)),
                                (a.point.y = x.y()(a.point)),
                                D.duration(0)
                                    .valueFormatter(function (a, c) {
                                        return b.tickFormat()(a, c);
                                    })
                        ...
                        function G(a) {
                            ...
                            (a.value = v.x()(a.data)),
                                (a.series = { value: v.y()(a.data), color: a.color, key: a.data.key }),
                                D.duration(0)
                                    .valueFormatter(function (a, c) {
                                        return b.tickFormat()(a, c);
                                    })
                        ...
                        a.utils.initSVG(H),
                            ...
                            (b.container = this);
                        var I = a.utils.availableWidth(g, H, e),
                            J = a.utils.availableHeight(h, H, e),
                        ...
                        o.domain(
                            d3.extent(d3.merge(S.concat(T)), function (a) {
                                return k(a);
                            })
                        ).range([0, I]);
                        ...
                        V.append('g').attr('class', 'nv-x nv-axis'),
                            V.append('g').attr('class', 'nv-y1 nv-axis'),
                            V.append('g').attr('class', 'nv-y2 nv-axis'),
                            V.append('g').attr('class', 'lines1Wrap'),
                            V.append('g').attr('class', 'lines2Wrap'),
                            V.append('g').attr('class', 'scatters1Wrap'),
                            V.append('g').attr('class', 'scatters2Wrap'),
                            V.append('g').attr('class', 'bars1Wrap'),
                            V.append('g').attr('class', 'bars2Wrap'),
                            V.append('g').attr('class', 'stack1Wrap'),
                            V.append('g').attr('class', 'stack2Wrap'),
                            V.append('g').attr('class', 'legendWrap');
                        var W = U.select('g'),
                            X = j.map(function (a, b) {
                        ...
                        if (i) {
                            ...
                            C.width(Y),
                                ...
                                W.select('.legendWrap')
                                    ...
                                    .call(C),
                                e.top != C.height() && ((e.top = C.height()), (J = a.utils.availableHeight(h, H, e))),
                                W.select('.legendWrap').attr('transform', 'translate(' + Z + ',' + -e.top + ')');
                        }
                        r
                            .width(I)
                            .height(J)
                        ...
                        var $ = W.select('.lines1Wrap').datum(
                                K.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            _ = W.select('.scatters1Wrap').datum(
                                M.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            aa = W.select('.bars1Wrap').datum(
                                O.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            ba = W.select('.stack1Wrap').datum(
                                Q.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            ca = W.select('.lines2Wrap').datum(
                                L.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            da = W.select('.scatters2Wrap').datum(
                                N.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            ea = W.select('.bars2Wrap').datum(
                                P.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                            fa = W.select('.stack2Wrap').datum(
                                R.filter(function (a) {
                                    return !a.disabled;
                                })
                            ),
                        ...
                        p
                            .domain(
                                c ||
                                    d3.extent(d3.merge(S).concat(ga), function (a) {
                                        return a.y;
                                    })
                            )
                            .range([0, J]),
                            q
                                .domain(
                                    d ||
                                        d3.extent(d3.merge(T).concat(ha), function (a) {
                                            return a.y;
                                        })
                                )
                                .range([0, J]),
                            ...
                            w.yDomain(q.domain()),
                            y.yDomain(q.domain()),
                            Q.length && d3.transition(ba).call(x),
                            R.length && d3.transition(fa).call(y),
                            O.length && d3.transition(aa).call(v),
                            P.length && d3.transition(ea).call(w),
                            K.length && d3.transition($).call(r),
                            L.length && d3.transition(ca).call(s),
                            M.length && d3.transition(_).call(t),
                            N.length && d3.transition(da).call(u),
                            z._ticks(a.utils.calcTicksX(I / 100, j)).tickSize(-J, 0),
                            W.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + J + ')'),
                            d3.transition(W.select('.nv-x.nv-axis')).call(z),
                            A._ticks(a.utils.calcTicksY(J / 36, j)).tickSize(-I, 0),
                            d3.transition(W.select('.nv-y1.nv-axis')).call(A),
                            B._ticks(a.utils.calcTicksY(J / 36, j)).tickSize(-I, 0),
                            d3.transition(W.select('.nv-y2.nv-axis')).call(B),
                            W.select('.nv-y1.nv-axis')
                                .classed('nv-disabled', S.length ? !1 : !0)
                                .attr('transform', 'translate(' + o.range()[0] + ',0)'),
                            W.select('.nv-y2.nv-axis')
                                .classed('nv-disabled', T.length ? !1 : !0)
                                .attr('transform', 'translate(' + o.range()[1] + ',0)'),
                            C.dispatch.on('stateChange', function (a) {
                                b.update();
                            }),
                            r.dispatch.on('elementMouseover.tooltip', n),
                            s.dispatch.on('elementMouseover.tooltip', n),
                            r.dispatch.on('elementMouseout.tooltip', function (a) {
                                D.hidden(!0);
                            }),
                            s.dispatch.on('elementMouseout.tooltip', function (a) {
                                D.hidden(!0);
                            }),
                            t.dispatch.on('elementMouseover.tooltip', E),
                            u.dispatch.on('elementMouseover.tooltip', E),
                            ...
                            x.dispatch.on('elementMouseover.tooltip', F),
                            y.dispatch.on('elementMouseover.tooltip', F),
                            ...
                            v.dispatch.on('elementMouseover.tooltip', G),
                            w.dispatch.on('elementMouseover.tooltip', G),
            ...
            var c,
                ...
                t = a.models.scatter().yScale(p),
                u = a.models.scatter().yScale(q),
                v = a.models.multiBar().stacked(!1).yScale(p),
                w = a.models.multiBar().stacked(!1).yScale(q),
                x = a.models.stackedArea().yScale(p),
                y = a.models.stackedArea().yScale(q),
                z = a.models.axis().scale(o).orient('bottom').tickPadding(5),
                A = a.models.axis().scale(p).orient('left'),
                B = a.models.axis().scale(q).orient('right'),
                C = a.models.legend().height(30),
                D = a.models.tooltip(),
                E = d3.dispatch();
            return (
                (b.dispatch = E),
                ...
                return (
                    y.each(function (b) {
                        ...
                        l.domain(c || d3.extent(b[0].values.map(n).concat(t))),
                            v
                                ? l.range(e || [(0.5 * y) / b[0].values.length, (y * (b[0].values.length - 0.5)) / b[0].values.length])
                ...
                return (
                    ...
                    N.each(function (b) {
                        ...
                        m.domain(
                            ...
                            y && b[0]
                                ? m.range(G || [(R * z + R) / (2 * b[0].values.length), R - (R * (1 + z)) / (2 * b[0].values.length)])
                                : m.range(G || [0, R]),
                            n
                                .domain(
                                    F ||
                    ...
                    z.each(function (z) {
                        ...
                        P.enter().append('line').attr('class', 'nv-regLine').style('stroke-opacity', 0),
                            ...
                            c.dispatch.on('elementMouseout.tooltip', function (a) {
                                i.hidden(!0),
                                    m
                                        .select('.nv-chart-' + c.id() + ' .nv-series-' + a.seriesIndex + ' .nv-distx-' + a.pointIndex)
                                        .attr('y1', 0),
                                    m
                                        .select('.nv-chart-' + c.id() + ' .nv-series-' + a.seriesIndex + ' .nv-disty-' + a.pointIndex)
                                        .attr('x2', h.size());
                            }),
                            c.dispatch.on('elementMouseover.tooltip', function (a) {
                                m.select('.nv-series-' + a.seriesIndex + ' .nv-distx-' + a.pointIndex).attr('y1', a.relativePos[1] - H),
                                    m
                ...
                return (
                    ...
                    k.each(function (k) {
                        var z = d3.select(this),
                            H = this;
                        a.utils.initSVG(z);
                        var M = a.utils.availableWidth(m, z, l),
                            N = a.utils.availableHeight(n, z, l);
                        if (
                            ((b.update = function () {
                                z.transition().duration(E).call(b);
                            }),
                            (b.container = this),
                            x.setter(K(k), b.update).getter(J(k)).update(),
                        ...
                        var P = z.selectAll('g.nv-wrap.nv-stackedAreaChart').data([k]),
                            ...
                            R = P.select('g');
                        if (
                            (Q.append('rect').style('opacity', 0),
                            Q.append('g').attr('class', 'nv-x nv-axis'),
                            Q.append('g').attr('class', 'nv-y nv-axis'),
                            Q.append('g').attr('class', 'nv-stackedWrap'),
                            Q.append('g').attr('class', 'nv-legendWrap'),
                            Q.append('g').attr('class', 'nv-controlsWrap'),
                            Q.append('g').attr('class', 'nv-interactive'),
                            R.select('rect').attr('width', M).attr('height', N),
                            q)
                        ) {
                            var S = p ? M - B : M;
                            h.width(S),
                                R.select('.nv-legendWrap').datum(k).call(h),
                                l.top != h.height() && ((l.top = h.height()), (N = a.utils.availableHeight(n, z, l))),
                                R.select('.nv-legendWrap').attr('transform', 'translate(' + (M - S) + ',' + -l.top + ')');
                        }
                        if (p) {
                            var T = [
                                { key: D.stacked || 'Stacked', metaKey: 'Stacked', disabled: 'stack' != e.style(), style: 'stack' },
                                { key: D.stream || 'Stream', metaKey: 'Stream', disabled: 'stream' != e.style(), style: 'stream' },
                                { key: D.expanded || 'Expanded', metaKey: 'Expanded', disabled: 'expand' != e.style(), style: 'expand' },
                                {
                            ...
                            (B = (C.length / 3) * 260),
                                ...
                                R.select('.nv-controlsWrap').datum(T).call(i),
                                l.top != Math.max(i.height(), h.height()) &&
                                    ((l.top = Math.max(i.height(), h.height())), (N = a.utils.availableHeight(n, z, l))),
                                R.select('.nv-controlsWrap').attr('transform', 'translate(0,' + -l.top + ')');
                        }
                        P.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
                            t && R.select('.nv-y.nv-axis').attr('transform', 'translate(' + M + ',0)'),
                            u &&
                                (j.width(M).height(N).margin({ left: l.left, top: l.top }).svgContainer(z).xScale(c),
                                P.select('.nv-interactive').call(j)),
                            e.width(M).height(N);
                        ...
                        if (
                            ...
                            r &&
                                (f
                                    .scale(c)
                                    ._ticks(a.utils.calcTicksX(M / 100, k))
                                    .tickSize(-N, 0),
                                R.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + N + ')'),
                                R.select('.nv-x.nv-axis').transition().duration(0).call(f)),
                            s)
                        ) {
                            var V;
                            if (
                                ((V = 'wiggle' === e.offset() ? 0 : a.utils.calcTicksY(N / 36, k)),
                                g.scale(d)._ticks(V).tickSize(-M, 0),
                        ...
                        e.dispatch.on('areaClick.toggle', function (a) {
                            ...
                            j.dispatch.on('elementMousemove', function (c) {
                                    ...
                                    (k
                                        ...
                                        .forEach(function (f, j) {
                                            ...
                                            if ((null != m && e.highlightPoint(j, g, !0), 'undefined' != typeof k)) {
                                                ...
                                                i.push({ key: f.key, value: n, color: o(f, f.seriesIndex), stackedValue: k.display }),
                                ...
                                'expand' === e.style() || 'stack_percent' === e.style()
                                    ? (G || (G = q), (q = d3.format('.1%')))
                                    : G && ((q = G), (G = null)),
                                    j.tooltip.chartContainer(H.parentNode).valueFormatter(q).data({ value: p, series: i })(),
                                    j.renderGuideLine(h);
                            }),
                            j.dispatch.on('elementMouseout', function (a) {
                                e.clearHighlights();
                            ...
                            A.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    'undefined' != typeof a.style && (e.style(a.style), (I = a.style)),
                                    b.update();
                            });
                    }),
                    H.renderEnd('stacked Area chart immediate'),
                    b
                );
            }
            var c,
        ...
        (a.models.sunburstChart = function () {
            ...
            return (
                d.headerEnabled(!1).valueFormatter(function (a, b) {
                    return a;
                }),
                c.dispatch.on('elementMouseover.tooltip', function (a) {
