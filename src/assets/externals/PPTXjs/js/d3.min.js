!(function () {
                        ...
                        'j' in r
                            ...
                            ? ('w' in r || (r.w = 'W' in r ? 1 : 0),
                              ...
                              a.setFullYear(
                                  r.y,
                                  0,
                                  'W' in r ? ((r.w + 6) % 7) + 7 * r.W - ((a.getDay() + 5) % 7) : r.w + 7 * r.U - ((a.getDay() + 6) % 7)
                              ))
    ...
    function Ft(n, t, e, r) {
        var u,
            ...
            a = Math.sin(n - e);
        return Ma(a) > Da
            ? Math.atan((Math.sin(t) * (i = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (u = Math.cos(t)) * Math.sin(n)) / (u * i * a))
            : (t + r) / 2;
    }
    function Ht(n, t, e, r) {
        var u;
    ...
    function Ai(n, t) {
        ...
        var e = n.length != t.length,
            ...
            l = 1;
        if (
            (e && ((r += 'Q' + (i[0] - (2 * a[0]) / 3) + ',' + (i[1] - (2 * a[1]) / 3) + ',' + i[0] + ',' + i[1]), (u = n[1]), (l = 2)),
            t.length > 1)
        ) {
            (o = t[1]),
                (i = n[l]),
    ...
    (oa.selection.enter = Z),
        ...
        (oa.select = function (t) {
            var e;
            return (
                'string' == typeof t ? ((e = [ka(t, sa)]), (e.parentNode = sa.documentElement)) : ((e = [t]), (e.parentNode = n(t))), E([e])
            );
        }),
        (oa.selectAll = function (n) {
            var t;
            return (
                'string' == typeof n ? ((t = ca(Na(n, sa))), (t.parentNode = sa.documentElement)) : ((t = ca(n)), (t.parentNode = null)),
                E([t])
            );
        }),
    ...
    (oa.geo.path = function () {
        function n(n) {
            return (
                n &&
                    ('function' == typeof o && i.pointRadius(+o.apply(this, arguments)), (a && a.valid) || (a = u(i)), oa.geo.stream(n, a)),
                i.result()
            );
        }
        function t() {
                ...
                if (
                    ...
                    i && a
                        ? ((r = e.C),
                          ...
                          (e.L = i),
                          (i.U = e),
                          e !== a ? ((u = e.U), (e.U = n.U), (n = e.R), (u.L = n), (e.R = a), (a.U = e)) : ((e.U = u), (u = e), (n = e.R)))
                        : ((r = n.C), (n = e)),
                    n && (n.U = u),
                    !r)
                ) {
    ...
    (oa.interpolateTransform = $r),
        ...
        (oa.layout.force = function () {
            ...
            return (
                ...
                (l.drag = function () {
                    return (
                        r || (r = oa.behavior.drag().origin(y).on('dragstart.force', Qr).on('drag.force', t).on('dragend.force', nu)),
        ...
        (oa.svg.chord = function () {
            function n(n, o) {
                ...
                return (
                    ...
                    (e(l, c) ? u(l.r, l.p1, l.r, l.p0) : u(l.r, l.p1, c.r, c.p0) + r(c.r, c.p1, c.a1 - c.a0) + u(c.r, c.p1, l.r, l.p0)) +
                    'Z'
                );
            }
            function t(n, t, e, r) {
        ...
        (Il.transition = function () {
            for (var n, t, e, r, u = this.id, i = ++Yl, a = this.namespace, o = [], l = 0, c = this.length; c > l; l++) {
                ...
                for (var t = this[l], s = 0, f = t.length; f > s; s++)
                    (e = t[s]) &&
                        ((r = e[a][u]), Qi(e, s, a, i, { time: r.time, ease: r.ease, delay: r.delay + r.duration, duration: r.duration })),
                        n.push(e);
            }
            return Wi(o, a, i);
        }),
        ...
        function i() {
            ...
            function d() {
                ...
                x && ((n[0] += x[0]), (n[1] += x[1])),
                    C ||
                        (oa.event.altKey
                            ? (M || (M = [(f[0] + f[1]) / 2, (h[0] + h[1]) / 2]), (L[0] = f[+(n[0] < M[0])]), (L[1] = h[+(n[1] < M[1])]))
                            : (M = null)),
                    E && m(n, c, 0) && (r(k), (t = !0)),
                    A && m(n, s, 1) && (u(k), (t = !0)),
