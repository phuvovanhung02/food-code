    ...
    $.fn.pptxToHtml = function (options) {
        ...
        function processSingleSlide(zip, sldFileName, index, slideSize) {
            ...
            */
            ...
            if (settings.slideMode && settings.slideType == 'revealjs') {
                var result =
                    "<section class='slide' style='width:" + slideSize.width + 'px; height:' + slideSize.height + 'px;' + bgColor + "'>";
            } else {
                var result =
                    "<div class='slide' style='width:" + slideSize.width + 'px; height:' + slideSize.height + 'px;' + bgColor + "'>";
            }
            ...
            if (shapType !== undefined && custShapType === undefined) {
                switch (shapType) {
                    ...
                    case 'corner':
                        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd']);
                        var sAdj1,
                            sAdj1_val = (50000 * 96) / 914400;
                        var sAdj2,
                            sAdj2_val = (50000 * 96) / 914400;
                        var cnsVal = (100000 * 96) / 914400;
                        if (shapAdjst_ary !== undefined) {
                            for (var i = 0; i < shapAdjst_ary.length; i++) {
                                var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name']);
                    ...
                    case 'cloudCallout':
                        ...
                        var d1 = 'M' + x0 + ',' + y0 + arc1 + arc2 + arc3 + arc4 + arc5 + arc6 + arc7 + arc8 + arc9 + arc10 + arc11 + ' z';
                    ...
                    case 'wave':
                        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd']);
                        var sAdj1,
                            adj1 = shapType == 'doubleWave' ? (6250 * 96) / 914400 : (12500 * 96) / 914400;
                        var sAdj2,
                            adj2 = 0;
                        if (shapAdjst_ary !== undefined) {
                            for (var i = 0; i < shapAdjst_ary.length; i++) {
                    ...
                    case 'ellipseRibbon2':
                        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd']);
                        var sAdj1,
                            adj1 = (25000 * 96) / 914400;
                        var sAdj2,
                            adj2 = (50000 * 96) / 914400;
                        var sAdj3,
                            adj3 = (12500 * 96) / 914400;
                        if (shapAdjst_ary !== undefined) {
                            for (var i = 0; i < shapAdjst_ary.length; i++) {
                                var sAdj_name = getTextByPathList(shapAdjst_ary[i], ['attrs', 'name']);
                                if (sAdj_name == 'adj1') {
                    ...
                    case 'quadArrow':
                        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd']);
                        var sAdj1,
                            adj1 = (22500 * 96) / 914400;
                        var sAdj2,
                            adj2 = (22500 * 96) / 914400;
                        var sAdj3,
                            adj3 = (22500 * 96) / 914400;
                        var cnstVal1 = (50000 * 96) / 914400;
                        var cnstVal2 = (100000 * 96) / 914400;
                    ...
                    case 'homePlate':
                        ...
                        x1 = w - dx1;
                        var d_val =
                            'M' + 0 + ',' + 0 + ' L' + x1 + ',' + 0 + ' L' + w + ',' + vc + ' L' + x1 + ',' + h + ' L' + 0 + ',' + h + ' z';
                    ...
                    case 'quadArrowCallout':
                        var shapAdjst_ary = getTextByPathList(node, ['p:spPr', 'a:prstGeom', 'a:avLst', 'a:gd']);
                        var sAdj1,
                            adj1 = (18515 * 96) / 914400;
                        var sAdj2,
                            adj2 = (18515 * 96) / 914400;
                        var sAdj3,
                            adj3 = (18515 * 96) / 914400;
                        var sAdj4,
                            adj4 = (48123 * 96) / 914400;
                        var cnstVal1 = (50000 * 96) / 914400;
                        var cnstVal2 = (100000 * 96) / 914400;
                    ...
                    case 'mathPlus':
                        ...
                        if (shapType == 'mathNotEqual') {
                            ...
                            var a1, ma1, ma3h, ma3w, maxAdj3, a3, m4a3, maxAdj2, a2, dy1, yg, rad, dx1, y3, y4, a, y2, y1, y5, x1, x3, x2;
        ...
        function processPicNode(node, warpObj) {
            ...
            rtrnData =
                ...
                (mediaProcess && audioPlayerFlag
                    ? getPosition(audioObjc, undefined, undefined)
            ...
            if ((vdoNode === undefined && audioNode === undefined) || !mediaProcess || !mediaSupportFlag) {
                rtrnData +=
                    "<img src='data:" + mimeType + ';base64,' + base64ArrayBuffer(imgArrayBuffer) + "' style='width: 100%; height: 100%'/>";
                    ...
                    if (t.charCodeAt(l) == s) {
                        ...
                        if (t.charCodeAt(l + 1) === v) {
                            if (t.charCodeAt(l + 2) == m) {
                                for (
                                    ;
                                    -1 !== l && (t.charCodeAt(l) !== d || t.charCodeAt(l - 1) != m || t.charCodeAt(l - 2) != m || -1 == l);
