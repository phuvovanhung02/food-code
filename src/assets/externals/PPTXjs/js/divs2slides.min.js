...
!(function (e) {
        ...
        o = {
                    ...
                    ? ((l.isInit = !0),
                      ...
                      e('#' + s + ' .slides-toolbar').prepend(
                          e('<img></img>')
                              ...
                              .on('click', o.nextSlide)
                      ),
                      l.showTotalSlideNum &&
                          e('#' + s + ' .slides-toolbar').prepend(
                              e('<span></span>').attr({ id: 'slides-total-slides-num' }).html(l.totalSlides)
                          ),
                      l.showSlideNum &&
                          l.showTotalSlideNum &&
                          e('#' + s + ' .slides-toolbar').prepend(
                              e('<span></span>').attr({ id: 'slides-slides-num-separator' }).html(' / ')
                          ),
                      l.showSlideNum &&
                          e('#' + s + ' .slides-toolbar').prepend(e('<span></span>').attr({ id: 'slides-slide-num' }).html(l.slideCount)),
                      l.showFullscreenBtn &&
                          e('#' + s + ' .slides-toolbar').prepend(
                              e('<img></img>')
                                  .attr({
                      ...
                      e('.slides-nav, .slides-nav-play').on('mouseover', function () {
                      ...
                      1 == l.slideCount
                          ? e('#' + s + ' #slides-prev').hide()
                          : l.slideCount == l.totalSlides
                          ? e('#' + s + ' #slides-next').hide()
                          : e('#' + s + ' #slides-next').show())
                    : (e('#' + s + ' .slides-toolbar').show(), (l.isEnbleNextBtn = !0), (l.isEnblePrevBtn = !0)),
                    null === document.getElementById('all_slides_warpper') &&
                        e('#' + s + ' .slide').wrapAll("<div id='all_slides_warpper'></div>"),
                    o.gotoSlide(1);
            },
            nextSlide: function () {
                var l = o.data,
                    ...
                    i = l.isAutoSlideMode;
                l.slideCount < l.totalSlides
                    ? (o.gotoSlide(l.slideCount + 1), i || e('#slides-next').show())
                    : s
                    ? o.gotoSlide(1)
                    : i || e('#slides-next').hide(),
                    i ||
                        (l.slideCount > 1 ? e('#slides-prev').show() : e('#slides-prev').hide(),
                        l.slideCount != l.totalSlides || s || e('#slides-next').hide());
            },
            prevSlide: function () {
                var l = o.data,
                    s = l.isAutoSlideMode;
                return (
                    l.slideCount > 1 && o.gotoSlide(l.slideCount - 1),
                    s || (1 == l.slideCount ? e('#slides-prev').hide() : e('#slides-prev').show(), e('#slides-next').show()),
                    this
                );
            },
            gotoSlide: function (l) {
                ...
                if (d[s]) {
                    var r = e(d[s]);
                    e(d[t]).is(':visible') &&
                        ('default' == n ? e(d[t]).hide(a) : 'fade' == n ? e(d[t]).fadeOut(a) : 'slid' == n && e(d[t]).slideUp(a)),
                        'default' == n ? r.show(a) : 'fade' == n ? r.fadeIn(a) : 'slid' == n && r.slideDown(a),
                        (i.prevSlide = s),
                        (o.data.slideCount = l),
                        e('#slides-slide-num').html(l);
                }
                return this;
            },
            keyDown: function (l) {
                ...
                switch (s) {
                    ...
                    case 116:
                        i.isSlideMode ||
                            (o.startSlideMode(),
                            (i.isSlideMode = !0),
                            (i.isAutoSlideMode || i.isLoopMode) &&
                                (clearInterval(i.loopIntrval), (i.isAutoSlideMode = !1), (i.isLoopMode = !1)));
                        break;
                    case 113:
            ...
            closeSileMode: function () {
                ...
                l.isSlideMode = !1;
                var s = l.divId;
                e('#' + s + ' .slides-toolbar').hide(),
                    e('#' + s + ' .slide').show(),
                    e(document.body).css('background-color', o.data.prevBgColor),
                    l.isLoopMode && (clearInterval(l.loopIntrval), (l.isLoopMode = !1)),
                    o.exitFullscreenMod();
            },
            startAutoSlide: function () {
                var l = o.data,
                    s = l.timeBetweenSlides;
                if (l.isAutoSlideMode || !1 === s) {
                    if ((clearInterval(l.loopIntrval), (l.isAutoSlideMode = !1), (l.isLoopMode = !1), l.nav)) {
                        d = l.divId;
                        e('#' + d + ' .slides-toolbar .slides-nav').show(),
                            e('#' + d + ' #slides-play-pause').attr(
                                'src',
                    ...
                    if (l.nav) {
                        var d = l.divId;
                        e('#' + d + ' .slides-toolbar .slides-nav').hide(),
                            e('#' + d + ' #slides-play-pause').attr(
                                'src',
                    ...
                    var t = s + l.transitionTime,
                        n = l.totalSlides,
                        a = l.randomAutoSlide;
                    if (i) clearInterval(l.loopIntrval), (l.isLoopMode = !1);
                    else {
                        var r = 1e3 * t;
                        (l.isLoopMode = !0),
                            (l.loopIntrval = setInterval(function () {
                                if (a) {
            ...
            fullscreen: function () {
                if (
                    ...
                    document.documentElement.requestFullscreen
                        ...
                        ? document.getElementById(a).msRequestFullscreen()
                        : document.documentElement.mozRequestFullScreen
                        ? document.getElementById(a).mozRequestFullScreen()
                        : document.documentElement.webkitRequestFullscreen &&
                          document.getElementById(a).webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT);
                    var r = e(window).width(),
                        u = e(window).height();
                    (l = e('#' + a).width()), (s = e('#' + a).height());
                    var A = e('#' + a + ' #all_slides_warpper').css('transform');
                    (i = A.substring(A.indexOf('(') + 1, A.indexOf(')')).split(',')),
                        e('#' + a + ' #all_slides_warpper .slide').offset().top,
                        e('#' + a + ' #all_slides_warpper .slide').offset().left,
                        (d = e('#' + a + ' .slides-toolbar').width()),
                        (t = e('#' + a + ' .slides-toolbar').offset().top),
                        e('#' + a).attr({ style: 'width: ' + (r - 10) + 'px; height: ' + (u - 10) + 'px;' }),
                        e('#' + a + ' #all_slides_warpper').css({ transform: 'scale(1)' });
                    var c = e('#' + a + ' #all_slides_warpper .slide').width(),
                        p = e('#' + a + ' #all_slides_warpper .slide').height();
                    e('#' + a + ' #all_slides_warpper .slide').css({ top: (u - p) / 2 + 'px', left: (r - c) / 2 + 'px' }),
                        n.nav && e('#' + a + ' .slides-toolbar').css({ width: '99%', top: '20px' }),
                        e('#' + a + ' #slides-full-screen').attr(
                            'src',
            ...
            exitFullscreenMod: function () {
                var n = o.data,
                    a = n.divId;
                e('#' + a).attr({ style: 'width: ' + l + 'px; height: ' + s + 'px;' }),
                    console.log(i[0]),
                    e('#' + a + ' #all_slides_warpper').css({ transform: 'scale(' + i[0] + ')' }),
                    e('#' + a + ' #all_slides_warpper .slide').css({ top: '0px', left: '0px' }),
                    n.nav && e('#' + a + ' .slides-toolbar').css({ width: d + 'px', top: t + 'px' }),
                    e('#' + a + ' #slides-full-screen').attr(
                        'src',
    ...
    e.fn.divs2slides = function (l) {
        var s = e(this),
            ...
            a = n.first;
        function r() {
            (!1 !== document.webkitIsFullScreen && !1 !== document.mozFullScreen && null !== document.msFullscreenElement) ||
                o.exitFullscreenMod();
        }
        (o.data = {
            nav: n.nav,
            ...
            n.keyBoardShortCut && e(document).bind('keydown', o.keyDown),
